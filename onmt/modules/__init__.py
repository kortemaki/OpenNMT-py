...
from onmt.modules.Embeddings import Embeddings, PositionalEncoding, IdentityEmbeddings
...
__all__ = [EncoderBase, MeanEncoder, RNNDecoderBase, InputFeedRNNDecoder,
           ...
           LayerNorm,
           TransformerEncoder, TransformerDecoder, Embeddings, IdentityEmbeddings, Elementwise,
